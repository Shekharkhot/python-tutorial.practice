...
# # WAPTCW the given data is float or not
# data = 26.6
# if type(data) == float:
...
# # WAPTCW the given data is dictionary or not
# data = {"mobile": 2}
# if type(data) == dict:
#     print("Its dictionary")


# # WAPTCW the given data is integer, and it is greater than 100 or not
# num = 250
# if type(num) == int and num > 100:
